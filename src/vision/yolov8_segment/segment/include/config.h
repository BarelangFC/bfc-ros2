...
const int kMaxNumOutputBbox = 3;  // assume the box outputs no more than kMaxNumOutputBbox boxes that conf >= kNmsThresh;
...
//const cv::Scalar kFieldColor(0, 255, 0);  // Green
const cv::Scalar kBallColor(0, 0, 255);  // Red
